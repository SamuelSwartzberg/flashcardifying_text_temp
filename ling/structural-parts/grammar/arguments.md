...
»⟮Grammatical voice⟯« is ⟮＿a sm grammatical feature category＿⟯ which ⟮changes the ＿valency＿ of a verblike⟯ and thus ⟮＿semantic roles＿ of ＿the verblikeal arguments＿⟯.
...
»⟮A thematic role⟯« is ⟮the semantic relationship⟯ ⟮a verblikeal argument⟯ has to ⟮its verblike⟯.
